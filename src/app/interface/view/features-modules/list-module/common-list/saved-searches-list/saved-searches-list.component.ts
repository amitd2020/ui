...
@Component({
	selector: 'dg-saved-searches-list',
...
export class SavedSearchesComponent implements OnInit {
	...
	getSavedFilterData( pageSize?, pageNumber? ) {
		...
		this.serverCommunicate.globalServerRequestCall( 'get', 'DG_LIST', 'getSaveFilteredLists', params ).subscribe( res => {
	...
	initBreadcrumbAndSeoMetaTags() {
		...
		// 	{ label: 'Saved Filters' }
		// ]);
		this.title = "Saved Filters - DataGardener";
		this.description = "In saved filters you can check details and records saved by client or customer.";
