...
export const environment = {
	production: false,
	json: 'assets/utilities/data',                        // JSON Path
	stripe_public_key: 'pk_test_sPSoo2Hqy7r7kMUHTu1qi8Yb',
	// server: 'http://localhost:3000',                     // Local Server
	// server: 'https://devapi.datagardener.com',        // Dev Server
	// server: 'https://irapi.datagardener.com',        // Dev Server ir
	server: 'https://preprodapi.datagardener.com',      // Preprod Server
	// server: 'http://13.40.7.216:9000',      // Preprod Server
	// server: 'https://preprodreports.datagardener.com',      // Preprod Server
